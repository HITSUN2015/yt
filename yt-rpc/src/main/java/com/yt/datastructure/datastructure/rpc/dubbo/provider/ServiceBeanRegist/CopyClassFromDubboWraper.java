...
//import com.alibaba.dubbo.common.bytecode.CopyClassGenerator;
 ...
 * {@link Wrapper}
 */
public abstract class CopyClassFromDubboWraper {
    ...
    {
        while( CopyClassGenerator.isDynamicClass(c) ) // can not wrapper on dynamic class.
            c = c.getSuperclass();
    ...
    public static Wrapper makeWrapper(Class<?> c)
    {
        ...
        CopyClassGenerator cc = CopyClassGenerator.newInstance(cl);
